...
The queue data structure has three main methods:
    ...
    - peek (returns the value of node at the front of the queue, without removing it)

--> A queue is a data structure composed of nodes, which follows a first in, first out (FIFO)
not protocol
"""
